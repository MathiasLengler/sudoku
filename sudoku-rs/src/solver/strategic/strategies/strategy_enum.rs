    ...
    impl<T> StrategyMap<T> {
        ...
        pub const fn get(&self, strategy: StrategyEnum) -> &T {
            match strategy {
                ...
                StrategyEnum::ChuteRemotePairs(_) => &self.chute_remote_pairs,
        ...
        pub const fn get_mut(&mut self, strategy: StrategyEnum) -> &mut T {
            match strategy {
                ...
                StrategyEnum::ChuteRemotePairs(_) => &mut self.chute_remote_pairs,
