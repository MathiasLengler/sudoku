    ...
    impl<T> StrategyMap<T> {
        ...
        pub const fn get(&self, strategy: StrategyEnum) -> &T {
            match strategy {
                ...
                StrategyEnum::SimpleColouring(_) => &self.simple_colouring,
        ...
        pub const fn get_mut(&mut self, strategy: StrategyEnum) -> &mut T {
            match strategy {
                ...
                StrategyEnum::SimpleColouring(_) => &mut self.simple_colouring,
